"""交易所采集器 collector runner(通用支撑包生成)。"""
...
COLLECTOR_PLUGIN_ID = "axdata.collector.exchange"
RUNNER_ENTRY = "axdata_collector_exchange.collectors:run_collector"
...
run_collector = make_runner("exchange")
